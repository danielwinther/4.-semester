...
public class TorsdagFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_torsdag, container, false);
    }
    ...
    private class FronterAsync extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                Elements mandag = skema.select(".emptySkemacell:nth-child(5) .skemabrik");
        ...
        protected void onPostExecute(Void result) {
            ...
            ListView listView = (ListView) getView().findViewById(R.id.listViewFronterTorsdag);
