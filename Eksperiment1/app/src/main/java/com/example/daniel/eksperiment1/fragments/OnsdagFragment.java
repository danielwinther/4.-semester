...
public class OnsdagFragment extends Fragment {
    private ProgressDialog progressDialog;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        new FronterAsync().execute();

        return inflater.inflate(R.layout.fragment_onsdag, container, false);
    }
    private class FronterAsync extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                Elements mandag = skema.select(".emptySkemacell:nth-child(4) .skemabrik");
        ...
        protected void onPostExecute(Void result) {
            ...
            ListView listView = (ListView) getView().findViewById(R.id.listViewFronterOnsdag);
